            ...
            {leaders.map((leader, index) => {
              ...
              return (
                ...
                >
                  ...
                  `} />
                  <div className={`
                    relative bg-slate-900/95 rounded-xl p-6 backdrop-blur-sm transition-all group-hover:scale-[1.02]
                  ...
                  `}>
                    <div className="flex items-center gap-6">
                      {/* Rank Badge */}
                      <div className={`
                        relative flex items-center justify-center w-14 h-14 rounded-full font-bold text-xl font-orbitron shadow-lg
                      ...
                      `}>
                        {rank === 1 && <Trophy className="absolute w-5 h-5 -top-1 -right-1 text-amber-300" />}
                        {rank}
                      </div>
                      ...
                      <div className="flex items-center gap-8">
                        <div className="text-center">
                          <div className="text-xs text-slate-500 uppercase tracking-[0.15em] mb-1 font-orbitron">
                            Reputation
                          </div>
                          <div className="text-2xl font-bold text-amber-400 font-mono drop-shadow-[0_0_8px_rgba(251,191,36,0.5)]">
                        ...
                        <div className="text-center">
                          ...
                          <div className="text-2xl font-bold text-emerald-400 font-mono drop-shadow-[0_0_8px_rgba(52,211,153,0.5)]">
                            {winRate}%
                          </div>
                        </div>
                        ...
                        <div className="text-center">
                          ...
                          <div className="text-2xl font-bold text-cyan-400 font-mono flex items-center gap-1 drop-shadow-[0_0_8px_rgba(34,211,238,0.5)]">
                            <TrendingUp size={18} />
                            {profit.toFixed(2)}
                          </div>
                        </div>
