      ...
      {isLoading ? (
        ...
        <div className="space-y-5 relative z-10">
          {marketData.map((data, index) => (
            <motion.div
              key={data.token}
              className="bg-slate-800/60 backdrop-blur-sm border border-slate-700/60 hover:border-cyan-400/40 rounded-xl p-5 md:p-6 transition-all duration-300 group"
